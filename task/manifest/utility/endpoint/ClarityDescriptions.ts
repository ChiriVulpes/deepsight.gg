...
export default Model(async () => {
	return await fetch('https://database-clarity.github.io/Live-Clarity-Database/descriptions/clarity.json')
		.then(response => response.json() as Promise<Record<number, ClarityDescription>>)
})
