...
const DeepsightPlugTypeMap = {
	[DeepsightPlugCategory.None]: null,
	[DeepsightPlugCategory.Classified]: null,
	[DeepsightPlugCategory.Unknown]: null,
	[DeepsightPlugCategory.Intrinsic]: DeepsightPlugTypeIntrinsic,
	[DeepsightPlugCategory.Perk]: DeepsightPlugTypePerk,
	[DeepsightPlugCategory.Mod]: DeepsightPlugTypeMod,
	[DeepsightPlugCategory.Subclass]: DeepsightPlugTypeSubclass,
	[DeepsightPlugCategory.Cosmetic]: DeepsightPlugTypeCosmetic,
	[DeepsightPlugCategory.Masterwork]: DeepsightPlugTypeMasterwork,
	[DeepsightPlugCategory.Artifact]: null,
	[DeepsightPlugCategory.Vendor]: DeepsightPlugTypeVendor,
	[DeepsightPlugCategory.StatusEffect]: null,
	[DeepsightPlugCategory.Infusion]: null,
	[DeepsightPlugCategory.Extractable]: DeepsightPlugTypeExtractable,
};

interface DeepsightPlugCategorisationGeneric<CATEGORY extends DeepsightPlugCategory = DeepsightPlugCategory> {
	category: CATEGORY;
	type: (typeof DeepsightPlugTypeMap)[CATEGORY];
}

interface DeepsightPlugCategorisationMasterwork extends DeepsightPlugCategorisationGeneric<DeepsightPlugCategory.Masterwork> {
	complete?: boolean;
	stat?: StatHashes;
	value?: number;
}

interface DeepsightPlugCategorisationMod extends DeepsightPlugCategorisationGeneric<DeepsightPlugCategory.Mod> {
	adept?: boolean;
...
interface DeepsightPlugCategorisationSubclass extends DeepsightPlugCategorisationGeneric<DeepsightPlugCategory.Subclass> {
...
type DeepsightPlugCategorisation<CATEGORY extends DeepsightPlugCategory = DeepsightPlugCategory> =
